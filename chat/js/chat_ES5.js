...
// для старых браузеров  https://jstool.gitlab.io/babel-es6-to-es5/
...
var usersData = [{
  uid: "6a09f20a-8de6-11e1-b3e1-001617ec3f2a",
  // уид пользователя
  name: "Петрович А.Х.",
  messages: [{
    date: "1987-05-15T00:00:00",
    // дата отправки
...
var messages = [{
  ...
  uid: "6a09f20a-8de6-11e1-b3e1-001617ec3f2a",
  // уид пользователя, который отправил сообщение
...
function renderUsersList() {
  ...
  for (var _i = 0, _Object$entries = Object.entries(usersCollections); _i < _Object$entries.length; _i++) {
    ...
    if (user !== null && user !== void 0 && user.status) {
...
function renderMessages() {
  ...
  for (var index = 0; index < messages.length; index++) {
    ...
    if (item !== null && item !== void 0 && item.sender) {
      li.classList.add("sender_".concat(item.sender));
    }
    ul.append(li);
  }
  slot.innerHTML = " ";
...
//  Рисуем чат
function reDrawChat() {
  return _reDrawChat.apply(this, arguments);
} // Устанавливаем юзеров первая функция
function _reDrawChat() {
  _reDrawChat = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
