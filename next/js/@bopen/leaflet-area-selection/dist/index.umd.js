(function (global, factory) {
  ...
  var styles = {"leafletAreaSelectorControl":"_37qQG","leafletMapOverlayPane":"_39tTo","drawPaneHelp":"_2Ftyt","endSelectionArea":"_3Xj9O","areaSelectMarker":"_1h_hk","areaSelectGhostMarker":"_1KD2U _1h_hk"};
  ...
  var DrawAreaSelection = leaflet.Control.extend({
    ...
    onAdd: function onAdd(map) {
      ...
      this.activateButton = leaflet.DomUtil.create('button', '', this._container);
    ...
    addUserHelpPanel: function addUserHelpPanel(pane) {
      ...
      var help = "Полигон должен состоять минимум из 3х точек и быть завершен завершен на первой точки!";
